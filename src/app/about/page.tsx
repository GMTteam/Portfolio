...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "nguyenanhtuatus@gmail.com",
    href: "mailto:nguyenanhtuatus@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/anh-t%C3%BA-nguy%E1%BB%85n-805995277/",
    content: "/andree",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/GMTteam",
    content: "/GMTteam",
...
const TOOLS = [
  ...
  },
  {
    name: "Swift",
    content: "Next.js is a React framework for production",
    icon: <FaSwift size={"50px"} color="#41b883" />,
    color: "#41b883",
  },
  {
    name: "Express.js",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Andree</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Andree, an Indie developer passionate about
              creating meaningful digital experiences. With great in Mobile
